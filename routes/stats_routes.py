...
def get_team_performance(constructorId):
    ...
    return stats_controller.get_team_performance(constructorId, season)
...
def get_qualif_vs_race(id):
    season = request.args.get('season')
    driver = request.args.get('driver')
    return stats_controller.get_qualif_vs_race(id, season, driver)

# 7. Performances dans les arrêts au stand
@stats_api.route('/constructors/<int:id>/pitstops', methods=['GET'])
def get_pitstops(id):
    season = request.args.get('season')
    return stats_controller.get_pitstops(id, season)
...
def compare_constructors():
    ...
    season = request.args.get('season')
    return stats_controller.compare_constructors(ids, season)
...
def get_top_circuits(id):
    season = request.args.get('season')
    driver = request.args.get('driver')
    return stats_controller.get_top_circuits(id, season, driver)
...
def get_driver_averages(id):
    ...
    return stats_controller.get_driver_averages_by_race(id, season, circuit)
...
def get_grid_stats(id):
    ...
    driver = request.args.get('driver')
    circuit = request.args.get('circuit')
    return stats_controller.get_grid_stats(id, season, driver, circuit)
...
def get_podium_ratio(id):
    season = request.args.get('season')
    return stats_controller.get_podium_ratio(id, season)
...
def get_sprint_laps(id):
    ...
    driver = request.args.get('driver')
    circuit = request.args.get('circuit')
    return stats_controller.get_sprint_laps(id, season, driver, circuit)
...
def get_standing_evolution(id):
    season = request.args.get('season')
    return stats_controller.get_standing_evolution(id, season)
...
def get_full_comparison(id):
    season = request.args.get('season')
    driver = request.args.get('driver')
    return stats_controller.get_full_comparison(id, season, driver)
