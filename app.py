...
db = client["formula_one"]
circuits_collection = db["f_one"]  # <- Nom corrigé

# Route 1 – Lister tous les circuits
@app.route("/circuits", methods=["GET"])
def get_all_circuits():
    circuits = list(circuits_collection.find({}, {"_id": 0}))
